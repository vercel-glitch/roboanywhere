        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-text-secondary">
                ...
                <Link href="/demo" className="text-primary-600 hover:text-primary-700 hover:underline font-medium">
                  Request a demo
                </Link>
              </p>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-3 px-4 border border-secondary-300 rounded-lg shadow-sm bg-white text-sm font-medium text-text-secondary hover:bg-secondary-50 transition-colors duration-200"
              >
